...
# from models.transnuseg_spatial_attention import TransNuSeg
from models.extented_transnuseg import TransNuSeg
...
def main():
    ...
    if dataset == "Radiology":
        ...
        total_data = MyDataset(dir_path=data_path,in_chan=channel)
    ...
    dice_loss_br = DiceLoss(num_classes)
    ...
    for epoch in range(num_epoch):
        ...
        for phase in ['train','test']:
            ...
            for i, d in enumerate(dataloaders[phase]):
                ...
                loss_val = dice_loss_val(output1, semantic_seg_mask.float(), softmax=True)
                ...
                br_edge = normal_edge_mask - cluster_edge_mask
                br_edge[br_edge<0] = 0
                br_loss = dice_loss_br(pred_edge_1,br_edge.float(),input_one_hot=True)
                
                ### calculating total loss
                loss = alpha*loss_seg + beta*loss_nor + gamma*loss_clu + ratio_d*dis_loss + 0.3*br_loss
                ...
                running_acc_val += (1 - loss_val.item())
            ...
            epoch_acc_val = running_acc_val / dataset_sizes[phase]
            ...
            if phase == 'train':
                ...
                train_accuracy.append(epoch_acc_val)
            else:
            ...
            if phase == 'test' and epoch_loss_seg < best_loss:
                ...
                logging.info("Best val acc {} save at epoch {}".format(epoch_acc_val,epoch+1))
    ...
    draw_accuracy(train_accuracy,test_accuracy,str(now))
